  ...
  return (
    <main className="min-h-screen">
      <PageHero
        ...
        subtitle="Deine IT-Weiterbildung wird vollständig finanziert. Wir zeigen dir, wie du den Bildungsgutschein beantragst und optimal nutzt."
        badge={{
          icon: Award,
          text: "100% Förderung möglich"
        }}
